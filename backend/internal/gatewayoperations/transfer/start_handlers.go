...
func (s FileTransferHTTPHandlers) StartUploadBatch(w http.ResponseWriter, r *http.Request) {
	runtime, ok := s.activeRuntimeOrLocked(w)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) createUploadBatchFromMultipart(w http.ResponseWriter, r *http.Request, runtime *transferapp.Runtime, source string, status *string, authorize func(runtimeID int64) bool, prepare func(runtimeID int64, remoteDir string, fileNames []string, overwrite bool) bool) (uploadBatchCreation, bool) {
...
func (s FileTransferHTTPHandlers) prepareUploadBatchMultipart(w http.ResponseWriter, r *http.Request, runtime *transferapp.Runtime, source string, status *string, authorize func(runtimeID int64) bool, prepare func(runtimeID int64, remoteDir string, fileNames []string, overwrite bool) bool) (uploadBatchMultipartPlan, bool) {
...
func (s FileTransferHTTPHandlers) StartDownload(w http.ResponseWriter, r *http.Request) {
	runtime, ok := s.activeRuntimeOrLocked(w)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) StartDownloadBatch(w http.ResponseWriter, r *http.Request) {
	runtime, ok := s.activeRuntimeOrLocked(w)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) createDownloadBatch(ctx context.Context, runtime *transferapp.Runtime, accepted *transferExecution, runtimeID int64, remotePaths []string, archiveName string, source string, status string, idempotencyKey string) (filetransfer.BatchRecord, bool, error) {
...
func (s FileTransferHTTPHandlers) CreateAndLaunchDownloadBatch(ctx context.Context, runtime *transferapp.Runtime, authorization connectorapi.TransferAuthorization, runtimeID int64, remotePaths []string, archiveName string, source string) (filetransfer.BatchRecord, error) {
...
func (s FileTransferHTTPHandlers) writeFileTransferStartError(w http.ResponseWriter, ctx context.Context, runtime *transferapp.Runtime, runtimeID int64, err error) bool {
	if writeFileTransferIdempotencyError(w, err) {
		return true
	}
...
func (s FileTransferHTTPHandlers) DownloadTransferredFile(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
