...
func (s FileTransferHTTPHandlers) GetFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) PauseFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) ResumeFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) CancelFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) ApproveFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) DeclineFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
...
func (s FileTransferHTTPHandlers) DownloadFileTransferBatch(w http.ResponseWriter, r *http.Request) {
	id, ok := parseID(w, r)
	if !ok {
		return
	}
