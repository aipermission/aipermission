...
func (s FileTransferHTTPHandlers) checkUploadOverwrite(w http.ResponseWriter, r *http.Request, execution transferExecution, remotePath string, overwrite bool, tempPath string) bool {
...
func (s FileTransferHTTPHandlers) checkUploadBatchOverwrite(w http.ResponseWriter, r *http.Request, execution transferExecution, requests []filetransfer.CreateRequest, overwrite bool, tempPaths []string) ([]remoteFileConflict, bool) {
