...
func (s FileTransferHTTPHandlers) downloadBatchExecution(ctx context.Context, runtime *transferapp.Runtime, accepted *transferExecution, runtimeID int64) (transferExecution, error) {
	if accepted == nil {
