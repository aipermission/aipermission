...
func TestCreateConsoleSessionReturnsHostKeyConflict(t *testing.T) {
	...
	runtime.ConnectorPort().SetConsoleSessionManager(console.NewManager(fixture.db, func(context.Context, console.RuntimeOpenRequest) (*console.RuntimeSession, error) {
