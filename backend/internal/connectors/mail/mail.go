...
func (Connector) TargetSchema() connectors.Schema {
	return connectors.Schema{Fields: []connectors.Field{
		...
		{Name: "imap_port", Label: "IMAP port", Type: connectors.FieldInteger, Required: true, Default: defaultIMAPPort},
		...
		{Name: "smtp_port", Label: "SMTP port", Type: connectors.FieldInteger, Required: true, Default: defaultSMTPPort},
