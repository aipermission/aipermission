...
rest-contract:
	cd backend && go run ./cmd/openapi -routes internal/gatewayinfrastructure/routes.go -output ../docs/api/openapi.json

rest-contract-check:
	cd backend && go run ./cmd/openapi -routes internal/gatewayinfrastructure/routes.go -output ../docs/api/openapi.json -check
