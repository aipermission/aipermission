  ...
  return (
    <>
      ...
      <ConnectionModeFields
        ...
        targets={targets}
        onChange={onChange}
        transportNotice={`Host and port are resolved from the SSH server. Use 127.0.0.1:6379 when ${product} only listens on the remote machine.`}
      ...
      <NetworkEndpointFields
        form={form}
        onChange={onChange}
        hostLabel={`${product} host`}
        className="sm:grid-cols-[minmax(0,1fr)_120px_120px]"
        trailing={
          <Field>
            Database
