  ...
  return (
    ...
    >
      ...
      <div className="grid gap-2 md:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        ...
        >
          <Input
            ...
            value={browser.publish.exchange}
        ...
        <FieldBlock
          ...
          help={
            browser.activeQueue
              ? `Use ${browser.activeQueue} to publish to the selected queue via amq.default.`
      ...
      >
        <Input
          className={styles.input}
          value={browser.publish.properties}
      ...
      >
        <Textarea
          className={`h-full min-h-0 resize-none font-mono text-xs ${styles.input}`}
          value={browser.publish.payload}
